...
import com.roach.base.bean.ZTreeBean;
...
public class DataClusterController {
    ...
    public String treeInit() {
        try {
            JedisCluster cluster = ClusterUtil.openCluster(DataUtil.getCurrentOpenConnect());
            if (null != cluster) {
                List<RedisNode> nodeList = ClusterUtil.getClusterNode(DataUtil.getCurrentOpenConnect());
    ...
    public String recoveryKey() {
        try {
            ...
            if (null != cluster) {
                ...
                if (null != file) {
                    ClusterUtil.recoveryKey(cluster, FileUtil.readFileToString(file.toString()));
